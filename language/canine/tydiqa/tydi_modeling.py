...
class GenericModelBuilder(metaclass=abc.ABCMeta):
    ...
    @abc.abstractmethod
    def create_encoder_model(self, is_training, input_ids, input_mask, segment_ids):
    ...
    def model_fn_builder(
        ...
        def model_fn(features, labels, mode, params):
            ...
            encoder_model = self.create_encoder_model(
            ...
            if mode == tf_estimator.ModeKeys.TRAIN:
                ...
                start_accuracy, start_distance = compute_metrics(
                    start_logits, start_positions
                )
                end_accuracy, end_distance = compute_metrics(end_logits, end_positions)
